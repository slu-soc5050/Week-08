...
![](https://img.shields.io/github/last-commit/slu-soc5050/Week-08.svg) ![](https://img.shields.io/github/repo-size/slu-soc5050/Week-08.svg)

### Repository Contents
This repository contains files for:
  - `Functions/` - function quick reference sheet
  - `Lab/` - lab instructions for lab-08
  - `LaTeX/` - LaTeX quick reference sheet
  - `PS-06/` - Problem Set 06 instructions
  - `Slides/` - slides for all lectures
  - `WeeklyPrep/` - weekly prep for week 08
  - `.gitignore`
  - `LICENSE`
  - `LICENSE_TEXT.md`
  - `README.md`
